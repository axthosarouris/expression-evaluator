...
/**
 * Precompiled com.github.axthosarouris.java-library-conventions script plugin.
 **/
public class ComGithubAxthosarourisJavaLibraryConventionsPlugin implements org.gradle.api.Plugin<org.gradle.api.internal.project.ProjectInternal> {
    ...
    public void apply(org.gradle.api.internal.project.ProjectInternal target) {
        ...
        try {
            Class<? extends BasicScript> pluginsBlockClass = Class.forName("cp_precompiled_ComGithubAxthosarourisJavaLibraryConventions").asSubclass(BasicScript.class);
            ...
            target.getPluginManager().apply("com.github.axthosarouris.java-common-conventions");
            target.getPluginManager().apply("java-library");


            Class<? extends BasicScript> precompiledScriptClass = Class.forName("precompiled_ComGithubAxthosarourisJavaLibraryConventions").asSubclass(BasicScript.class);
